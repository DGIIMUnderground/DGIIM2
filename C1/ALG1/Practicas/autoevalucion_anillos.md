...
**d)** Esta es la afirmación verdadera. Sea $I$ un ideal de $K$, entonces si $a\in I$, $a\neq 0$, por ser $K$ un cuerpo, existe $a^{-1}\in K$, y por ser $I$ un ideal, $a·a^{-1}=1\in I$, por lo que $I=K$. En conclusión, cualquier ideal de $K$ va a ser o $K$ o el vacío.
